...
def registration():
    if request.method == "POST":
        ...
        cur.execute("INSERT INTO People(id,firstName, lastName, passport, sity, email, mobile, data_born) VALUES (%d,%s,%s,%s,%s,%s,%s,%s,%s)", (id, firstName, lastName, passport, sity, email, mobile, data_born))
        cur.execute("INSERT INTO Creds(id, email, password) VALUES (%d,%s,%s)",(id,email,md5))
